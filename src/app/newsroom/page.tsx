...
//       date: "2025-10-16",
//       type: "WATCH",
//       image: "/new1.png", // ✅ Replace with your image path
//     },
//     {
//       title:
...
//       {/* ✅ Main Content */}
//       <main className="ml-44 flex-1 px-8 md:px-16 py-8">
//         {/* ✅ Featured News Section */}
//         <section className="flex flex-col lg:flex-row items-center gap-12 mb-20">
//           {/* Left Column */}
//           <div className="flex-1">
//             <h1 className="text-4xl md:text-3xl font-normal leading-tight mb-6">
...
//           <div className="flex-1">
//             <Image
//               src="/new1.png" // ✅ Replace with your image
...
//             <div className="border-b border-gray-100 my-12 w-[965px]"></div>
//           </div>
...
//   {/* ✅ Footer */}
//         <div className="flex justify-center items-center min-h-[40vh] ml-12 mt-12 bg-[#151617]">
//           <h1
//             className="text-[100px] md:text-[160px] font-extrabold text-transparent  mr-40 -mb-8  uppercase tracking-wide"
//             style={{
//               backgroundImage:
...
export default function NewsroomPage() {
  ...
  return (
    <div className="flex bg-[#151617] text-white min-h-screen">
      ...
      {/* ✅ Main Content */}
      <main className="lg:ml-44 max-lg:ml-0 flex-1 px-4 sm:px-8 md:px-16 py-8 w-full">
        {/* ✅ Featured News Section */}
