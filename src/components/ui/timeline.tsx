      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          >
            ...
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-gray-700 dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-cyan-200 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 p-2" />
              </div>
        ...
        >
          <motion.div
           ...
           className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-cyan-500 via-gray-400 to-transparent rounded-full"
